...
exports.numberToText = exports.numtoTxt = void 0;
const numtoTxt = function (number) {
    ...
    if (decimals.length < 2)
        decimals = decimals + '0';
    aString = (0, exports.numberToText)(Math.floor(+num));
    aString = aString.charAt(0).toUpperCase() + aString.slice(1);
    result = aString;
    return result.trim();
};
exports.numtoTxt = numtoTxt;
const numberToText = function (number, translate) {
    var fullNumberText = '', aString, numberBlocks, ind1, ind2, aNumberString, numberString, str1, str2, str3, sep1, sep2, aTextNumber, index, temp, aMilesSeparatorText;
